...
## [21.1.0](https://github.com/ufoscout/revm/compare/revm-v21.0.0...revm-v21.1.0) - 2025-04-07

### Added

- support for system calls ([#2350](https://github.com/ufoscout/revm/pull/2350))
- Reorder revm deps in Cargo.toml ([#2331](https://github.com/ufoscout/revm/pull/2331))
